...
namespace DATN_QLKS
{
    public partial class ThongTinKhachChoNhanVien : System.Web.UI.Page
    {
        ...
        protected void InsertButton_Click(object sender, EventArgs e)
        {
            ...
            cmd8.Parameters.AddWithValue("PhuongThuc", "Trực Tiếp");
            ...
            foreach (var item in ds)
            {
                ...
                cmd9.Parameters.AddWithValue("TrangThai", "2");
